(function (global, factory) {
  ...
  */
  ...
  var require$$1 = ( warning$2 && warning_1$1 ) || warning$2;
    ...
    function createUnionTypeChecker(arrayOfTypeCheckers) {
      ...
      for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
        ...
        if (typeof checker !== 'function') {
          require$$1(false, 'Invalid argument supplied to oneOfType. Expected an array of check functions, but ' + 'received %s at index %s.', getPostfixForTypeWarning(checker), i);
          return emptyFunction$2.thatReturnsNull;
        }
      }
  ...
  var createTransitionManager$1 = unwrapExports(createTransitionManager_1);

  var createTransitionManager$2 = /*#__PURE__*/Object.freeze({
    default: createTransitionManager$1,
    __moduleExports: createTransitionManager_1
  });

  var _LocationUtils = ( LocationUtils$2 && LocationUtils$1 ) || LocationUtils$2;

  var _createTransitionManager = ( createTransitionManager$2 && createTransitionManager$1 ) || createTransitionManager$2;
